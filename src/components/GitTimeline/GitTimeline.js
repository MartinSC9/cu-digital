...
export const getProjects = (t) => [
  ...
  { key: 'miarbol', name: 'Mi Árbol en el Mundo', category: ['mobile', 'landing'], tag: 'Web + Mobile', featured: true, description: t.projects.miarbol.description, duration: t.projects.miarbol.duration },
  { key: 'viuti', name: 'Viutify', category: 'webapp', tag: 'SaaS', featured: true, description: t.projects.viuti.description, duration: t.projects.viuti.duration },
  { key: 'quicknotes', name: 'Quick Notes', category: 'desktop', tag: 'Desktop', featured: true, video: '/videos/quick-notes.mp4', description: t.projects.quicknotes.description, duration: t.projects.quicknotes.duration },
  { key: 'standford', name: 'Gana con Standford', category: ['webapp', 'landing'], tag: 'Web App', featured: true, description: t.projects.standford.description, duration: t.projects.standford.duration },
